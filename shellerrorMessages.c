...
/**
 * getErrorMessage126 - Creates an error message for permission denied.
...
char *getErrorMessage126(char **args)
{
	...
	len = calculateStringLength(name) +
	calculateStringLength(hist_str) + calculateStringLength(args[0]) + 24;
...
/**
 * getErrorMessage127 - Creates an error message for command not found.
 * @args: An array of arguments passed to the command.
 *
 * Return: The error string.
 */
